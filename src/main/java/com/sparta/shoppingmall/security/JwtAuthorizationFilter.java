...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain filterChain) throws ServletException, IOException {
        String accessToken = JwtProvider.getJwtFromHeader(req);
    ...
    private void handleExpiredAccessToken(HttpServletRequest req, HttpServletResponse res, ExpiredJwtException e) throws IOException {
        String refreshToken = jwtProvider.getJwtRefreshTokenFromHeader(req);
        ...
        if (StringUtils.hasText(refreshToken) && jwtProvider.validateRefreshToken(refreshToken)) {
            ...
            res.addHeader(JwtProvider.REFRESH_HEADER, refreshToken);
